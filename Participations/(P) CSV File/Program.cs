...
namespace _P__CSV_File
{
    class Program
    {
        ...
        {
            /* PROBLEM PROMPT: Create a Console application that will read (File.ReadAllLines) in the 
            ...
            //To add the file right click - click add file - click the file - then properties change to "add always"

            //To read in the file we are going to call a function (below)
            ...
            //defining each variable for totaling up the sales for year year
            ...
            //The data we have and which index each column is
            //     0             2              3             4          5...
            ...
            //Now we need to iterate through each line of this file
