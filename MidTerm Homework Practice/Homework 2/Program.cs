...
namespace Homework_2
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            overall grade of 98% in their course) for their Accounting, Marketing, Economics and MIS courses.  
            Assume each course is worth 3 credit hours.  Once you have all of their grades output what letter grade
